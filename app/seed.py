...
DOCUMENTOS = [
    ...
    ("Política de Segurança Cibernética", "Política", "documentacao/evidencias/politica_seguranca_cibernetica.md", "semestral", date(2026, 9, 16)),
    ...
    # Planos
    ("Plano de Continuidade de Negócios (BCP)", "Plano", "documentacao/evidencias/plano_continuidade_negocios.md", "semestral", date(2026, 9, 16)),
    ("Plano de Recuperação de Desastres (DRP)", "Plano", "documentacao/evidencias/plano_recuperacao_desastres.md", "semestral", date(2026, 9, 16)),

    # LGPD / Compliance
    ("DPA — Acordo de Processamento de Dados", "LGPD", "documentacao/evidencias/dpa_acordo_processamento_dados.md", "anual", date(2026, 9, 16)),
    ("RIPD — Relatório de Impacto à Privacidade", "LGPD", "documentacao/evidencias/ripd_relatorio_impacto_privacidade.md", "anual", date(2026, 9, 16)),
    ("RoPA — Registro de Atividades de Tratamento", "LGPD", "documentacao/evidencias/ropa_registro_atividades_tratamento.md", "semestral", date(2026, 9, 16)),
    ...
    ("Evidências de Infraestrutura", "Técnico", "documentacao/evidencias/evidencias_infraestrutura.md", "trimestral", date(2026, 9, 16)),
    ...
    # Registros
    ("Custos de Infraestrutura", "Registro", "documentacao/evidencias/custos_infraestrutura.md", "mensal", date(2026, 9, 16)),
    ("Log de Disponibilidade", "Registro", "documentacao/evidencias/log_disponibilidade.md", "mensal", date(2026, 9, 16)),
